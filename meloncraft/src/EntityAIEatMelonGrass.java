...
public class EntityAIEatMelonGrass extends EntityAIBase
{
    ...
    public EntityAIEatMelonGrass(EntityLiving par1EntityLiving)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            return this.theWorld.getBlockId(i, j - 1, k) == MelonCraft.melonGrass.blockID;
        }
    }
    ...
    public void updateTask()
    {
        ...
        if (this.eatGrassTick == 4)
        {
            ...
            if (this.theWorld.getBlockId(i, j, k) == MelonCraft.melonGrass.blockID)
            {
                this.theWorld.func_94578_a(i, j, k, false);
                this.theEntity.eatGrassBonus();
            }
            else if (this.theWorld.getBlockId(i, j - 1, k) == MelonCraft.melonGrass.blockID)
            {
                this.theWorld.playAuxSFX(2001, i, j - 1, k, MelonCraft.melonGrass.blockID);
                this.theWorld.setBlockAndMetadataWithNotify(i, j - 1, k, MelonCraft.melonDirt.blockID, 0, 2);
                this.theEntity.eatGrassBonus();
            }
        }
    }
