...
public class MelonCraft {
        ...
        public final static Item moonStoneSword = new MelonSword(2581, "moonstoneSword", 767, 7).setUnlocalizedName("moonStoneSword");
        public final static Item moonstoneIngot = new MelonItem(2582, "moonstoneIngot", 64).setUnlocalizedName("moonIngot");
        ...
        public void load(FMLInitializationEvent event) {
        	...
        	//Block names, registerBlocks
                ...
                LanguageRegistry.addName(plazmaOre, "Plasma Ore");
                ...
                LanguageRegistry.addName(PLZH, "Plasma/Moonstone Helmet");
                LanguageRegistry.addName(PLZC, "Plasma/Moonstone Chestplate");
                LanguageRegistry.addName(PLZL, "Plasma/Moonstone Greaves");
                LanguageRegistry.addName(PLZB, "Plasma/Moonstone Boots");
                LanguageRegistry.addName(plazPick, "Plasma Pickaxe");
                LanguageRegistry.addName(plazSword, "Plasma Sword");
                LanguageRegistry.addName(plazmaGem, "Plasma Gem");
                ...
                LanguageRegistry.addName(plazShov, "Plasma Shovel");
                ...
                LanguageRegistry.addName(plazAxe, "Plasma Axe");
