...
public class WorldGenDyeTree extends WorldGenerator
{
    ...
    public WorldGenDyeTree(boolean par1)
    {
        this(par1, 3, 0, 0, false);
    }

    public WorldGenDyeTree(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                	...
                	par1World.func_94575_c(par3, par4, par5, MelonCraft.dyeLog.blockID);
                	par1World.func_94575_c(par3, par4+1, par5, MelonCraft.dyeLog.blockID);
                	par1World.func_94575_c(par3, par4+2, par5, MelonCraft.dyeLog.blockID);
                	par1World.func_94575_c(par3, par4+3, par5, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3, par4+4, par5, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3+1, par4+3, par5, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3-1, par4+3, par5, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3, par4+3, par5+1, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3, par4+3, par5-1, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3+1, par4+2, par5, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3-1, par4+2, par5, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3+1, par4+2, par5+1, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3-1, par4+2, par5-1, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3+1, par4+2, par5-1, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3-1, par4+2, par5+1, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3, par4+2, par5+1, MelonCraft.dyeLeaf.blockID);
                	par1World.func_94575_c(par3, par4+2, par5-1, MelonCraft.dyeLeaf.blockID);
                	return true;
                }
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        //this.setBlockAndMetadata(par1World, j2, j1, l2, MelonCraft.dyeLeaf.blockID, this.metaLeaves);
                                    }
                                }
                            }
                        }
