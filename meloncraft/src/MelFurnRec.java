...
public class MelFurnRec
{
    private static final MelFurnRec smeltingBase = new MelFurnRec();
     ...
     */
    public static final MelFurnRec smelting()
    {
        return smeltingBase;
    }
    ...
    private MelFurnRec()
    {
        this.addSmelting(MelonCraft.moonstoneOre.blockID, new ItemStack(MelonCraft.moonstoneIngot, 1), 0.7F);
        this.addSmelting(MelonCraft.plazmaOre.blockID, new ItemStack(MelonCraft.plazmaGem, 1), 0.7F);
        this.addSmelting(MelonCraft.melonDirt.blockID, new ItemStack(MelonCraft.melStnShrd, 1), 0.7F);
        this.addSmelting(MelonCraft.melonSeedBlock.blockID, new ItemStack(MelonCraft.melonGlass, 1), 0.7F);
        this.addSmelting(Item.melon.itemID, new ItemStack(MelonCraft.roastMelon, 1), 0.7F);
