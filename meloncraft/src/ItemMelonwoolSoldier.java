...
public class ItemMelonwoolSoldier extends Item
{
	private int clr;
	private String tex;
    public ItemMelonwoolSoldier(int par1, String text, int color)
    {
        super(par1);
        this.clr=color;
        this.tex=text;
    ...
    {    	
    	...
    	EntityMelonwoolSoldier var1 = new EntityMelonwoolSoldier(par0World);
