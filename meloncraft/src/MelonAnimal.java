...
public abstract class MelonAnimal extends EntityAgeable implements IAnimals
{
    public int inLove;
    ...
    public MelonAnimal(World par1World)
    {
        super(par1World);
    }
    ...
    protected void attackEntity(Entity par1Entity, float par2)
    {
        ...
        else if (par1Entity instanceof MelonAnimal)
        {
            MelonAnimal entityanimal = (MelonAnimal)par1Entity;
            ...
            else if (this.inLove > 0 && entityanimal.inLove > 0)
            {
                ...
                if (entityanimal.entityToAttack == this && (double)par2 < 3.5D)
                {
                    ...
                    if (this.breeding == 60)
                    {
                        this.procreate((MelonAnimal)par1Entity);
                    }
                }
                else
                {
     ...
     * particles.
     */
    private void procreate(MelonAnimal par1EntityAnimal)
    {
    ...
    {
        return this.worldObj.getBlockId(par1, par2 - 1, par3) == MelonCraft.melonGrass.blockID ? 10.0F : this.worldObj.getLightBrightness(par1, par2, par3) - 0.5F;
    }
    ...
    protected Entity findPlayerToAttack()
    {
        ...
        else
        {
            ...
            if (this.inLove > 0)
            {
                ...
                {
                    entityanimal = (MelonAnimal)list.get(i);
     ...
     */
    public boolean canMateWith(MelonAnimal par1EntityAnimal)
    {
