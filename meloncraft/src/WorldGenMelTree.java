...
public class WorldGenMelTree extends WorldGenerator
{
    ...
    public WorldGenMelTree(boolean par1)
    {
        this(par1, 3, 0, 0, false);
    }

    public WorldGenMelTree(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                {
                	par1World.func_94575_c(par3, par4-1, par5, MelonCraft.melonDirt.blockID);
                	par1World.func_94575_c(par3, par4, par5, MelonCraft.melonLog.blockID);
                	par1World.func_94575_c(par3, par4+1, par5, MelonCraft.melonLog.blockID);
                	par1World.func_94575_c(par3, par4+2, par5, MelonCraft.melonLog.blockID);
                	par1World.func_94575_c(par3, par4+3, par5, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3, par4+4, par5, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3+1, par4+3, par5, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3-1, par4+3, par5, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3, par4+3, par5+1, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3, par4+3, par5-1, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3+1, par4+2, par5, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3-1, par4+2, par5, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3+1, par4+2, par5+1, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3-1, par4+2, par5-1, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3+1, par4+2, par5-1, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3-1, par4+2, par5+1, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3, par4+2, par5+1, MelonCraft.melonLeaves.blockID);
                	par1World.func_94575_c(par3, par4+2, par5-1, MelonCraft.melonLeaves.blockID);
                	return true;
                }
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        //this.setBlockAndMetadata(par1World, j2, j1, l2, MelonCraft.melonLeaves.blockID, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, MelonCraft.melonLog.blockID, this.metaWood);
