...
public class MelonLeaves extends Block
{
    ...
    protected MelonLeaves(int par1, String texture)
    {
                    ...
                    for (l1 = -b0; l1 <= b0; ++l1)
                    {
                        for (i2 = -b0; i2 <= b0; ++i2)
                        {
                            for (j2 = -b0; j2 <= b0; ++j2)
                            {
                                ...
                                if (block != null && block.blockID==MelonCraft.melonLog.blockID)
                                {
                                    this.adjacentTreeBlocks[(l1 + k1) * j1 + (i2 + k1) * b1 + j2 + k1] = 0;
                                }
                                else if (block != null && block.blockID==MelonCraft.melonLeaves.blockID)
                                {
    ...
    {
        return MelonCraft.melSap.blockID;
    }
