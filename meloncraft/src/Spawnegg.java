...
public class Spawnegg extends Item
{
	private int mob;
	private String tex;
    public Spawnegg(int par1, String text, int i)
    {
        super(par1);
        this.mob=i;
        this.tex=text;
    ...
    {    	
    	...
    	Entity mobToSpawn=new MelonZombie(par0World);
    	if(this.mob==1)
    		mobToSpawn=new MelonSheep(par0World);
    	mobToSpawn.setPosition(par2, par4, par6);
        par0World.spawnEntityInWorld(mobToSpawn);
        return mobToSpawn;
    }
}
