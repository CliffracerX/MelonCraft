...
public class MelonAxe extends Item
{
    ...
    private int dura;
    int tier;
    public MelonAxe(int id, String tex, int tier, int durability, float speed)
    {
        super(id);
    ...
    {
        if(par2Block.blockID == MelonCraft.melonlog.blockID || par2Block.blockID == MelonCraft.melonplanks.blockID)
        {
            return this.speed;
        }
        else
