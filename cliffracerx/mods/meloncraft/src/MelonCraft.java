...
public class MelonCraft
{
    ...
    public static int cyanmagicappedChargedWandID = 9834;
    public static int cyanmagicappedChargedWandFireFocusID = 9835;
    public static int cyanmagicappedChargedWandIceFocusID = 9836;
    public static int bluemagicappedChargedWandID = 9837;
    public static int bluemagicappedChargedWandFireFocusID = 9838;
    public static int bluemagicappedChargedWandIceFocusID = 9839;
    public static int purplemagicappedChargedWandID = 9840;
    public static int purplemagicappedChargedWandFireFocusID = 9841;
    public static int purplemagicappedChargedWandIceFocusID = 9842;
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
      ...
      //Config.
        ...
        cyanmagicappedChargedWandID = config.get(Configuration.CATEGORY_ITEM, "Cyan magi-capped charged moonstone wand ItemID", 9834).getInt(9834);
        cyanmagicappedChargedWandFireFocusID = config.get(Configuration.CATEGORY_ITEM, "Cyan magi-capped charged moonstone wand with a fire focus ItemID", 9835).getInt(9835);
        cyanmagicappedChargedWandIceFocusID = config.get(Configuration.CATEGORY_ITEM, "Cyan magi-capped charged moonstone wand with a ice focus ItemID", 9836).getInt(9836);
        bluemagicappedChargedWandID = config.get(Configuration.CATEGORY_ITEM, "Blue magi-capped charged moonstone wand ItemID", 9837).getInt(9837);
        bluemagicappedChargedWandFireFocusID = config.get(Configuration.CATEGORY_ITEM, "Blue magi-capped charged moonstone wand with a fire focus ItemID", 9838).getInt(9838);
        bluemagicappedChargedWandIceFocusID = config.get(Configuration.CATEGORY_ITEM, "Blue magi-capped charged moonstone wand with a ice focus ItemID", 9839).getInt(9839);
        purplemagicappedChargedWandID = config.get(Configuration.CATEGORY_ITEM, "Purple magi-capped charged moonstone wand ItemID", 9840).getInt(9840);
        purplemagicappedChargedWandFireFocusID = config.get(Configuration.CATEGORY_ITEM, "Purple magi-capped charged moonstone wand with a fire focus ItemID", 9841).getInt(9841);
        purplemagicappedChargedWandIceFocusID = config.get(Configuration.CATEGORY_ITEM, "Purple magi-capped charged moonstone wand with a ice focus ItemID", 9842).getInt(9842);
