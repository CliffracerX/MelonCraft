...
public class MelonBlockSapling extends Block
{
    public static final String[] WOOD_TYPES = new String[] {"oak", "spruce", "birch", "jungle"};
    private static final String[] field_94370_b = new String[] {"melonSapling", "sapling_spruce", "sapling_birch", "sapling_jungle"};
    ...
    protected MelonBlockSapling(int par1, Material ground, String texture, int blockID, int blockID2)
    {
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            object = new WorldGenMelTree(true, 3, this.logID, this.leavesID, false);
