...
public class MelonChunkProvider implements IChunkProvider
{
    ...
    public MelonChunkProvider(World world, long l)
    {
        unusedSandNoise = new double[256];
        unusedGravelNoise = new double[256];
        sNoise = new double[256];
        //caveGen = new MelonCaveGen();
                    ...
                    for (int l1 = 0; l1 < 4; l1++)
                    {
                        ...
                        for (int i2 = 0; i2 < 8; i2++)
                        {
                            ...
                            for (int k2 = 0; k2 < 8; k2++)
                            {
                                ...
                                if (d15 > 0.0D)
                                {
                                    l2 = MelonCraft.melonStone.blockID;
                                }
    ...
    public void replaceBlocksForBiome(int i, int j, byte abyte0[], BiomeGenBase abiomegenbase[])
    {
        ...
        sNoise = field_28082_o.generateNoiseOctaves(sNoise, i * 16, j * 16, 0, 16, 16, 1, d * 2D, d * 2D, d * 2D);
        ...
        for (int k = 0; k < 16; k++)
        {
            for (int l = 0; l < 16; l++)
            {
                ...
                int i1 = (int)(sNoise[k + l * 16] / 3D + 3D + random.nextDouble() * 0.25D);
                int j1 = -1;
                byte byte0 = (byte) MelonCraft.melonGrass.blockID;
                byte byte1 = (byte) MelonCraft.melonDirt.blockID;
                worldObj.getClass();
                ...
                for (int k1 = 127; k1 >= 0; k1--)
                {
                    ...
                    if (j1 == -1)
                    {
                        ...
                        {
                            byte0 = 0;
                            byte1 = (byte)MelonCraft.melonStone.blockID;
                        }
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        //biomegenbase.decorate(worldObj, worldObj.rand, i, j);
        ...
        for (int j2 = 0; j2 < 20; j2++)
        {
            ...
            (new MelonOreGen(MelonCraft.melonDirt.blockID, 32, MelonCraft.melonStone.blockID)).generate(worldObj, random, l5, i9, k13);
        }
        ...
        for (int i11 = 0; i11 < l7; i11++)
        {
            ...
            WorldGenerator worldgenerator = new WorldGenMelTree(true);
        ...
        if (random.nextInt(8) == 0)
        {
            int k15 = k + random.nextInt(16) + 8;
            int j18 = l + random.nextInt(16) + 8;
            WorldGenerator worldgenerator = new MagistoneGen();
            worldgenerator.setScale(1.0D, 1.0D, 1.0D);
            worldgenerator.generate(worldObj, random, k15, worldObj.getHeightValue(k15, j18), j18);
            System.out.println("Made it to MagiStone generator code!");
        }
        ...
        /*if (random.nextInt(32) == 0)
        {
            int k15 = k + random.nextInt(16) + 8;
            int j18 = l + random.nextInt(16) + 8;
            WorldGenerator worldgenerator = new MelDragEggGen();
            worldgenerator.setScale(1.0D, 1.0D, 1.0D);
            worldgenerator.generate(worldObj, random, k15, worldObj.getHeightValue(k15, j18), j18);
            System.out.println("OHMYGODMELONDRAGONEGG");
        }*/
        ...
        /*for (int k17 = 0; k17 < 50; k17++)
        {
            ...
            (new WorldGenLiquids(MelonCraft.melonjuice.blockID)).generate(worldObj, random, j20, l21, l22);
        }
