...
public class MelonBlockGrass extends Block
{
    ...
    {
        return par1 == 1 ? this.iconGrassTop : (par1 == 0 ? MelonCraft.melonDirt.getBlockTextureFromSide(par1) : this.blockIcon);
    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                par1World.setBlock(par2, par3, par4, MelonCraft.melonDirt.blockID);
            }
    ...
    public Icon getBlockTexture(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            return MelonCraft.melonDirt.getBlockTextureFromSide(par5);
        }
        else
        {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("MelonCraft:"+this.tex + "_side");
        this.iconGrassTop = par1IconRegister.registerIcon("MelonCraft:"+this.tex + "_top");
        this.iconSnowSide = par1IconRegister.registerIcon("MelonCraft:"+this.tex + "_side");
    }
}
