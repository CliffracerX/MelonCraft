...
public class WorldGenMelTree extends WorldGenerator
{
    ...
    {
        this(par1, 3, MelonCraft.melonlog.blockID, MelonCraft.melonleaves.blockID, false);
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                {
                	par1World.setBlock(par3, par4-1, par5, MelonCraft.melonDirt.blockID);
                	par1World.setBlock(par3, par4, par5, this.logID);
                	par1World.setBlock(par3, par4+1, par5, this.logID);
                	par1World.setBlock(par3, par4+2, par5, this.logID);
                	par1World.setBlock(par3, par4+3, par5, this.leavesID);
                	par1World.setBlock(par3, par4+4, par5, this.leavesID);
                	par1World.setBlock(par3+1, par4+3, par5, this.leavesID);
                	par1World.setBlock(par3-1, par4+3, par5, this.leavesID);
                	par1World.setBlock(par3, par4+3, par5+1, this.leavesID);
                	par1World.setBlock(par3, par4+3, par5-1, this.leavesID);
                	par1World.setBlock(par3+1, par4+2, par5, this.leavesID);
                	par1World.setBlock(par3-1, par4+2, par5, this.leavesID);
                	par1World.setBlock(par3+1, par4+2, par5+1, this.leavesID);
                	par1World.setBlock(par3-1, par4+2, par5-1, this.leavesID);
                	par1World.setBlock(par3+1, par4+2, par5-1, this.leavesID);
                	par1World.setBlock(par3-1, par4+2, par5+1, this.leavesID);
                	par1World.setBlock(par3, par4+2, par5+1, this.leavesID);
                	par1World.setBlock(par3, par4+2, par5-1, this.leavesID);
                	return true;
                }
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        //this.setBlockAndMetadata(par1World, j2, j1, l2, this.leavesID, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, this.logID, this.metaWood);
