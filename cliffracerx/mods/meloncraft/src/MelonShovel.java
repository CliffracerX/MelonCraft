...
public class MelonShovel extends Item
{
    private String texture;
    private float speed;
    private int dura;
    int tier;
    public MelonShovel(int id, String tex, int tier, int durability, float speed)
    {
        super(id);
    ...
    {
        if(par2Block.blockID == MelonCraft.melonGrass.blockID || par2Block.blockID == MelonCraft.melonDirt.blockID)
        {
            return this.speed;
        }
        else
